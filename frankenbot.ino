...
const uint16_t TURN_TIME_MS      = 600;   // your value
...
{
  // dir: +1 forward, -1 backward, 0 stop (coast/brake via pins low)
  if (dir > 0) 
  {
...
{
  // Your wiring: forward was (PIN1 LOW, PIN2 HIGH)
  if (dir > 0) 
  {
